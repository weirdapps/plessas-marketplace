...
| [`peer-banks.yaml`](peer-banks.yaml) | Executive committee | every peer-bank layout: logos under bars, beside horizontal bars, and in a legend row for bank series and a doughnut; a bank chart in a two_column half |
