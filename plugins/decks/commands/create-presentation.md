...
exhibit without a source. Apply the answers to `deck.yaml` (fill `content.source`, with an `as_of`
that carries its year, in the full form where you can, such as `Q2 2026` or `FY 2025`; remove the
